            ...
            <form action="/secretaria/crearprofesor" method="POST" class="p-6">
                ...
                <div class="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4 mt-8 pt-6 border-t border-gray-200">
                   ...
                   hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed" tabindex="8" id="guardarBtn" disabled>
                    ...
                    <button type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200" tabindex="9" onclick="window.location.href='/secretaria'">
                        CANCELAR
                    </button>
                </div>
            </form>
...
<script>
    ...
    const requiredFields = ['nombre_completo_profesor', 'email_profesor'];
