...
<body>
    ...
    <div class="flex justify-center space-x-4 mt-6">
        ...
        <div class="tooltip" data-tip="El plan ya fue aprobado por secretaría académica.">
            <button type="button" class="btn btn-success opacity-50 cursor-not-allowed" disabled tabindex="8">
                Aprobar plan
            </button>
        </div>
        @else
        ...
        {{-- ⚠️ Botón Rechazar para administración --}}
        @if($plan->estado === 'Aprobado por secretaría académica.')
        <div class="tooltip" data-tip="Una vez aprobado, solo puede ser rechazado hacia el profesor asociado.">
            <button type="button" class="btn btn-warning opacity-50 cursor-not-allowed" disabled tabindex="9">
