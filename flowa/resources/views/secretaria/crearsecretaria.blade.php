              ...
              <div class="my-3">
                ...
                <div class="my-3">
                    ...
                    <input id="DNI_secretaria" name="DNI_secretaria" type="number" class="input input-bordered w-full"
                        tabindex="3" required value="{{ old('DNI_secretaria') }}" placeholder="Ingrese el DNI">
                </div>
                <div class="my-3">
                    ...
                    <input id="legajo_secretaria" name="legajo_secretaria" type="number" class="input input-bordered w-full"
                        tabindex="4" required value="{{ old('legajo_secretaria') }}" placeholder="Ingrese el legajo">
                </div>
                <div class="my-3">
                    <label class="label"><span class="label-text">Email</span></label>
                    <input id="email_secretaria" name="email_secretaria" type="email" class="input input-bordered w-full"
                        tabindex="5" required value="{{ old('email_secretaria') }}" placeholder="Ingrese el email">
                </div>
                <div class="grid grid-cols-2 gap-4 content-center mt-10">
                    <a href="/secretaria" class="btn btn-secondary" tabindex="6">Cancelar</a>
