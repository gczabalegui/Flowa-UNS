...
@section('title', 'Crear nuevo usuario Secretaria Académica')
...
<div class="min-h-screen px-4 sm:px-8 lg:px-12 xl:px-16">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow border border-gray-200">
            <form action="/administracion/crearsecretaria" method="POST" class="p-6">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="nombre_secretaria" class="block text-sm font-medium text-gray-700 mb-2">Nombre</label>
                        <input id="nombre_secretaria" name="nombre_secretaria" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required value="{{ old('nombre_secretaria') }}" placeholder="Ingrese el nombre">
                    ...
                    <div>
                        ...
                        <input id="apellido_secretaria" name="apellido_secretaria" type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required value="{{ old('apellido_secretaria') }}" placeholder="Ingrese el apellido">
                    ...
                    <div>
                        ...
                        <input id="DNI_secretaria" name="DNI_secretaria" type="number" min="1" step="1" inputmode="numeric" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 no-spinners" required value="{{ old('DNI_secretaria') }}" placeholder="Ingrese el DNI" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                    ...
                    <div>
                        ...
                        <input id="legajo_secretaria" name="legajo_secretaria" type="number" min="1" step="1" inputmode="numeric" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 no-spinners" required value="{{ old('legajo_secretaria') }}" placeholder="Ingrese el legajo" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input id="email_secretaria" name="email_secretaria" type="email" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required value="{{ old('email_secretaria') }}" placeholder="Ingrese el email">
