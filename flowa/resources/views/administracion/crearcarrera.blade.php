        ...
        <div class="bg-white rounded-lg shadow border border-gray-200">
            <form action="/administracion/crearcarrera" method="POST" class="p-6">
                ...
                <div class="flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0 sm:space-x-4 mt-8 pt-6 border-t border-gray-200">
                    <div class="tooltip tooltip-top inline-block" data-tip="Todos los campos son requeridos para guardar la carrera." id="guardarTooltip">
...
<script>
    ...
    const requiredFields = ['nombre_carrera', 'departamento_id', 'codigo_carrera', 'plan_version', 'duracion', 'cant_materias'];
    ...
    function validateForm() {
        ...
        if (allValid) {
            ...
            guardarTooltip.setAttribute('data-tip', 'Todos los campos son requeridos para guardar la carrera.');
        }
    }
