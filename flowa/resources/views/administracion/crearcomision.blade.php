...
<div class="min-h-screen px-4 sm:px-8 lg:px-12 xl:px-16">
    <div class="max-w-7xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Crear nuevo usuario Coordinador de la Comisión Curricular</h1>
            <p class="text-gray-600 mt-2">Complete el formulario para registrar un nuevo coordinador de comisión curricular</p>
        </div>
            ...
            <form action="/administracion/crearcomision" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input id="DNI" name="DNI" type="number" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" tabindex="3" required value="{{ old('DNI') }}" placeholder="Ingrese el DNI">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Legajo</label>
                        <input id="legajo" name="legajo" type="number" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" tabindex="4" required value="{{ old('legajo') }}" placeholder="Ingrese el legajo">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select id="carrera_responsable" name="carrera_responsable" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" tabindex="6" required>
...
<script>
    ...
    const requiredFields = ['nombre_completo', 'email_comision', 'carrera_id'];
