            ...
            <div class="flex flex-col h-full pt-6">
                ...
                <nav class="flex-1 px-4 py-6 overflow-y-auto">
                    <div class="mb-6">
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('cambiar.rol', 'administracion') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition duration-150 ease-in-out group">
                            ...
                            <a href="{{ route('cambiar.rol', 'comision') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition duration-150 ease-in-out group">
                                <svg class="w-5 h-5 mr-3 text-gray-500 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('cambiar.rol', 'profesor') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition duration-150 ease-in-out group">
                                <svg class="w-5 h-5 mr-3 text-gray-500 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                </svg> Profesor responsable
                            </a>
                            <a href="{{ route('cambiar.rol', 'secretaria') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition duration-150 ease-in-out group">
                                <svg class="w-5 h-5 mr-3 text-gray-500 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
