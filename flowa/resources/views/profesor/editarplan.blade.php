               ...
               hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200" title="Formatear bibliografía en estilo APA con IA">
                            ...
                            <div class="flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0 sm:space-x-4 pt-6">
                                ...
                                <form id="reject-plan-form" action="{{ route('profesor.rechazarplan', ['id' => $plan->id]) }}" method="POST">
                                    ...
                                    <button type="button" class="w-36 h-12 flex items-center justify-center text-center px-3 py-2 text-sm font-medium rounded-md border 
                                    ...
                                    @endif" data-form="reject-plan-form" data-message="¿Está seguro de que desea rechazar este programa? Esta acción lo devolverá a administración." @if(!in_array($plan->estado, ['Completo por administración.', 'Incompleto por profesor.', 'Rectificado por administración para profesor responsable.']))
                                        disabled
                                        @endif>
                                ...
                                <div class="custom-tooltip" data-tip="No se puede guardar como borrador. Debe rectificar y enviar.">
                                    <button type="button" class="inline-flex items-center justify-center px-5 py-2 w-70 border text-sm font-medium rounded-md 
                                border-gray-300 text-gray-400 bg-gray-100 cursor-not-allowed opacity-70" disabled tabindex="13">
                                        GUARDAR BORRADOR
                                    </button>
                                </div>
                                @else
                                <button type="submit" name="action" value="guardar_borrador" class="inline-flex items-center justify-center px-5 py-2 w-50 border text-sm font-medium rounded-md 
                            ...
                            disabled:border-gray-300 disabled:text-gray-400 disabled:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-70" tabindex="13">
                                    GUARDAR BORRADOR
                                </button>
                                @endif
                                ...
                                <div class="custom-tooltip" data-tip="Complete todos los campos requeridos" id="guardarTooltip">
                                    <button type="submit" name="action" value="guardar" id="guardarBtn" class="inline-flex items-center justify-center px-5 py-2 w-50 text-sm font-medium rounded-md border transition-colors duration-200
            focus:outline-none focus:ring-2 focus:ring-offset-2
            @if(!in_array($plan->estado, ['Completo por administración.', 'Incompleto por profesor.', 'Rectificado por administración para profesor responsable.', 'Aprobado por secretaría académica.']))
                border-gray-300 text-gray-400 bg-gray-100 cursor-not-allowed opacity-70
            @else
                border-green-600 text-green-700 bg-white hover:bg-green-50 focus:ring-green-500
            @endif" tabindex="14" @if(!in_array($plan->estado, ['Completo por administración.', 'Incompleto por profesor.', 'Rectificado por administración para profesor responsable.', 'Aprobado por secretaría académica.']))
                                        disabled
                                        @endif>
                                        GUARDAR
                                    </button>
