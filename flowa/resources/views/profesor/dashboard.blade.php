            ...
            <div class="lg:col-span-1 bg-white p-6 rounded-lg shadow border flex flex-col">
                <h3 class="text-lg font-semibold text-gray-800">Datos de gestión</h3>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow border">
                        <p class="text-gray-600">Total de programas asignados</p>
                        <h2 class="text-3xl font-bold text-blue-600">{{ $totalPlanes }}</h2>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow border">
                        <p class="text-gray-600">Programas pendientes de completar</p>
                        <h2 class="text-3xl font-bold text-red-600">{{ $planesPendientes }}</h2>
                    </div>
                    <div class="bg-white p-6 rounded-lg shadow border">
                        <p class="text-gray-600">Materias asignadas</p>
                        <h2 class="text-3xl font-bold text-green-600">{{ $totalMaterias }}</h2>
                    </div>
                
            </div>

            <div class="bg-white p-6 rounded-lg shadow border flex flex-col">
                <h3 class="text-lg font-semibold text-gray-800 mb-4 text-center">Programas por estado</h3>
