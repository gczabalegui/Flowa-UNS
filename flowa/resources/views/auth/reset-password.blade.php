...
<head>
    ...
    <title>Restablecer contraseña - Flowa</title>
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8"
        ...
        <div class="text-center mb-6">
            <h1 class="text-3xl font-bold text-blue-800">Restablecer contraseña</h1>
            <p class="text-gray-600 mt-2">Ingrese su nueva contraseña para acceder al sistema.</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus
                    class="input input-bordered w-full focus:ring focus:ring-blue-200" placeholder="Ingrese su email">
            </div>
